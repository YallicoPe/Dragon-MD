...
await conn.sendFile(m.chat, pp, 'lp.jpg', menu, m, false, { contextInfo: { forwardedNewsletterMessageInfo: { newsletterJid: '120363160031023229@newsletter', serverMessageId: '', newsletterName: '𝗗𝗿𝗮𝗴𝗼𝗻 𝗕𝗼𝘁 🐉' }, mentionedJid, externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: wm, body: '𝗗𝗿𝗮𝗴𝗼𝗻 𝗕𝗼𝘁 🐉', previewType: 0, thumbnail: imagen3, sourceUrl: [md, yt, tiktok].getRandom()}}})
