...
text = (action === 'add' ? (chat.sWelcome || this.welcome || conn.welcome || 'Welcome, @user!').replace('@subject', await this.getName(id)).replace('@desc', groupMetadata.desc?.toString() || '𝗗𝗿𝗮𝗴𝗼𝗻 𝗕𝗼𝘁 🐉') :
...
let prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: msg, contextInfo: { externalAdReply: { title: lenguajeGB.smsAvisoAG().slice(0,-2), body: [wm, '𝗗𝗿𝗮𝗴𝗼𝗻 𝗕𝗼𝘁 🐉','https://chat.whatsapp.com/LHo0RmYd3pxAQzp24NYcTV'].getRandom(), thumbnail: gataImg.getRandom(), sourceUrl: [md, channel1, channel2, nna, yt, ig, paypal, fb].getRandom() }}}}, tg)
